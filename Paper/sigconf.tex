...
\title{A tangible VR system for training}
...
\affiliation{%
  \institution{Software Engineering Research Center, IIIT-H}
  \city{Hyderabad}
  \country{India}
}
...
\section{ACKNOWLEDGMENTS and ethics review}
